...
export default function ExpenseTemplateCreate({
    isOpen,
    onClose,
    ...
    const onSubmit = async (e) => {
        ...
        if (categoryTitle === "Джобни" && selectedChild) {
            newExpenseTemplate.child = selectedChild._id;
        }
        ...
        try {
            ...
            toast({
                title: "Шаблонът е създанен.",
                description: "Успешно създадохте шаблон.",
                status: "success",
                duration: 5000,
                isClosable: true,
            });
            ...
            if (error.status === 401) {
                ...
                toast({
                    ...
                    description:
                        error.message ||
                        "Възникна грешка при създаването на шаблона",
                    status: "error",
                    duration: 5000,
                    isClosable: true,
                });
    ...
    return (
        <Modal isOpen={isOpen} onClose={onCloseForm}>
            ...
            >
                <ModalHeader>Създайте шаблон</ModalHeader>
                <ModalCloseButton />
                <ModalBody pb={6}>
