...
export default function ReminderCreate({ isOpen, onClose, paidExpenseId }) {
    ...
    useEffect(() => {
        paidExpenseService
            .getOneNotApproved(householdId, paidExpenseId)
    ...
    const onSubmit = async (e) => {
        ...
        const newReminder = {
            message: `Имате неодобрен разход.`,
            household: householdId,
            receiver: values.receiver,
            resourceType: "paidExpense",
            resourceId: paidExpenseId,
        };
